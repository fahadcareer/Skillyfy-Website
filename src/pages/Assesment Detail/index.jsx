...
import { ClipboardCopy, CheckCircle, XCircle, BookOpen, Route, ArrowLeft, Loader2 } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <h1 className="text-2xl font-bold text-blue-600">Assessment Details</h1>
                <div />
            </div>

            {/* Score Card */}
            <div
                className={`bg-gradient-to-r ${getPerformanceColor()} text-white p-8 rounded-2xl shadow-md mb-10`}
            >
                <h2 className="text-lg text-white/90 font-medium">Your Score</h2>
                    ...
                    <div className="space-y-4">
                        {technical_assessment.map((q, idx) => {
                            ...
                            return (
                                <div
                                    key={idx}
                                    className={`bg-white rounded-xl border p-5 shadow-sm transition ${isAnswered
                                        ? isCorrect
                                            ? "border-green-300"
                                            : "border-red-300"
                                        : "border-gray-200"
                                ...
                                >
                                    ...
                                    <p className="text-sm text-gray-500 mb-3">Type: {q.type || "N/A"}</p>
                                    ...
                                    <div className="text-sm space-y-2">
                                        <p>
                                            ...
                                            >
                                                {isAnswered ? q.user_answer : "Not answered"}
                                            </span>
                                        </p>
                                        <p>
            ...
            <section>
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-lg font-semibold text-gray-800">Learning Roadmap</h3>
                    </div>
                    {roadmap.length > 0 && (
                        <button
                            onClick={copyRoadmap}
